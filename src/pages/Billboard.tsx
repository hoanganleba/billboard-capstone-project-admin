  ...
  return (
    <>
      <div className="flex items-center justify-between">
        <h1 className="text-2xl dark:text-white">Billboards</h1>
        <form>
          <label
            htmlFor="search"
            ...
            <tbody>
              {data.map((billboard: any) => (
                ...
                >
                  <th
                    scope="row"
                    className="py-4 px-6 underline underline-offset-4 font-medium text-gray-900 whitespace-nowrap dark:text-white"
                  >
                    <Link to={`/dashboard/billboards/${billboard.id}`}>
                      {billboard.name}
                    </Link>
                  </th>
                  <td className="py-4 px-6">
                    {statusValidate(billboard.isActive)}
                  </td>
                </tr>
              ))}
            </tbody>
